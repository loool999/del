...
k.ENVIRONMENT_IS_PTHREAD || k.$ww || function(a) {
    function b(n, p, q, u) {
        if ("object" === typeof process && "object" === typeof process.versions && "string" === typeof process.versions.node)
            ...
            v.onprogress = function(r) {
                ...
                r.total && (B = r.total);
                if (r.loaded) {
                    v.Fi ? k.vj[n].loaded = r.loaded : (v.Fi = !0,
                    k.vj || (k.vj = {}),
                    k.vj[n] = {
                        loaded: r.loaded,
                        total: B
                    ...
                    !k.vj && k.setStatus && k.setStatus("Downloading data...")
            }
            ;
            v.onerror = function() {
    ...
    "function" !== typeof k.locateFilePackage || k.locateFile || (k.locateFile = k.locateFilePackage,
    l("warning: you defined Module.locateFilePackage, that has been renamed to Module.locateFile (using your locateFilePackage for now)"));
    ...
    k.calledRun ? d() : (k.preRun || (k.preRun = []),
    k.preRun.push(d))
}({
    "files": [{
...
this.activate_clipboard = function() {
    !xa && navigator.clipboard && navigator.permissions && !ya && (ya = !0,
    navigator.permissions.query({
        ...
        if ("granted" == a.state || "prompt" == a.state) {
            ...
            for (a = 0; a < wa.length; ++a)
                navigator.clipboard.writeText(wa[a]);
            wa = [];
...
this.clipboard_set_text = function(a) {
    xa ? navigator.clipboard && navigator.clipboard.writeText(a) : (activate_clipboard(),
    wa.push(a))
}
;
var za = {}
            ...
            window.oprt.gameFiles.keys().then(f => {
                ...
                for (var n = 0; n < f.length; ++n) {
                    var p = f[n]
                      ...
                      , u = ""
                      , v = q.indexOf(":");
                    0 <= v && (u = q.substring(v + 1),
                    q = q.substring(0, v));
                    v = e.indexOf(q);
                    console.log("considering file " + q + " for deleting, indexOf is " + v + " cached MD5 is " + u + " manifest md5 is " + (0 > v ? " not present" : d[v]));
                ...
                za = f;
                void 0 == Aa["game.unx"] ? (console.log("caching game.unx"),
...
this.__gx_async_wget2 = function(a, b, c, d, e, f, g) {
    window.oprt && window.oprt.gameFiles && (a = Aa[a],
...
GXMFS = {
    ...
    lk: (a, b, c) => {
        ...
        Object.keys(a.entries).forEach(function(p) {
            var q = a.entries[p]
              , u = b.entries[p];
            u && q.timestamp.getTime() == u.timestamp.getTime() || (f.push(p),
            e++)
        });
...
var Na = Object.assign({}, k), Oa = [], Pa = "./this.program", Qa = (a, b) => {
    throw b;
}
, Ra = "object" == typeof window, Sa = "function" == typeof importScripts, Ta = "object" == typeof process && "object" == typeof process.versions && "string" == typeof process.versions.node, Ua = "", Va, Wa, Xa;
if (Ta) {
    var fs = require("fs")
      , Ya = require("path");
...
var db, eb = !1, fb, D, w, gb, hb, E, F, H, ib;
function jb() {
    var a = db.buffer;
...
function vb() {
    rb--;
    k.monitorRunDependencies && k.monitorRunDependencies(rb);
    if (0 == rb && (null !== sb && (clearInterval(sb),
    sb = null),
    tb)) {
        var a = tb;
        tb = null;
...
var xb = a => a.startsWith("data:application/octet-stream;base64,"), Za = a => a.startsWith("file://"), yb;
yb = "runner.wasm";
if (!xb(yb)) {
    var zb = yb;
...
var I, J, Mb = {
    ...
    ,
    1524654: (a, b, c, d, e, f) => {
        gxc_request_room(a ? x(w, a) : "", b ? x(w, b) : "", c, d, e ? x(w, e) : "", f ? x(w, f) : "")
    }
    ,
    1524756: (a, b, c, d) => {
    ...
    1527687: (a, b, c) => {
        ...
        if (null != d.Hj)
            return b = d.Hj.getImageData(0, 0, b, c),
    ...
    1528607: a => {
        ...
        const g = () => {
            ...
            null == h.Vi ? (h.Vi = document.createElement("canvas"),
            h.Vi.style.cssText = "position:fixed; top:1px; left:1px; width:1px; height:1px",
    ...
    1533430: (a, b, c, d) => {
        ...
        null == e.bj && (e.bj = document.createElement("canvas"),
        e.bj.style.cssText = "position:fixed; top:1px; left:1px; width:1px; height:1px",
        e.bj.width = a,
        e.bj.height = b,
        ...
        e.mj.Nl = !0,
        e.mj.muted = !0,
        e.mj.style.cssText = "position:fixed;top:1px;left:1px;width:1px;height:1px",
        document.body.appendChild(e.mj),
        e.mj.srcObject = e.yk,
        a = e.bj.captureStream(c),
        0 < d && (d = da.createMediaStreamDestination().stream.getAudioTracks().find(g => g.enabled),
        a.addTrack(d)),
    ...
    1537578: () => {
        var a = 640;
        "number" == typeof window.innerWidth ? a = window.innerWidth * window.devicePixelRatio : document.documentElement && document.documentElement.clientWidth ? a = document.documentElement.clientWidth : document.body && document.body.clientWidth && (a = document.body.clientWidth);
        return a
    }
    ,
    1537910: () => {
    ...
    1538404: (a, b, c, d) => {
        ...
        if (void 0 != window.oprt) {
            ...
            0 != (a & 5) && void 0 != h && "function" == typeof h ? (h(),
    ...
    1540796: (a, b, c, d, e, f, g, h) => {
        __gx_async_wget2(a ? x(w, a) : "", b ? x(w, b) : "", c ? x(w, c) : "", d, e, f, g, h)
    }
    ,
    1540893: a => {
        setAddAsyncMethod(a)
    ...
    1541568: (a, b, c, d, e) => {
        ...
        this.chrome && this.chrome.runtime && (e = w.subarray(e, e + 20),
        a = a ? x(w, a) : "",
        chrome.runtime.sendMessage(c ? x(w, c) : "", {
            command: d ? x(w, d) : "",
            randomString: a,
            hash: e
        }, f))
    ...
    ,
    1542128: () => window.matchMedia("(any-hover: none)").matches || window.matchMedia("(any-hover: hover) and (pointer: coarse)").matches || "undefined" != typeof window.oprt,
    ...
    1543015: () => {
        Gb("/_savedata");
        window.oprt && window.oprt.gameStorage ? Hb(GXMFS, "/_savedata") : Hb(L, "/_savedata");
        Eb(!0, function() {
    ...
    1547861: (a, b, c) => {
        ...
        for (let d = 0; d < b; ++d) {
            const e = ea.shift();
            for (let f = 0; f < c; ++f)
                Jb(a + 2 * (d * c + f), e[f], "i16")
        }
    }
    ,
    1548205: a => ea.length * a,
    1548291: () => null != ha && null != ka ? 1 : 0,
    1548404: () => "undefined" !== typeof AudioContext || "undefined" !== typeof webkitAudioContext ? !0 : !1,
    ...
    1548785: a => {
        ...
        var b = k.SDL2;
        a ? b.capture = {} : b.audio = {};
        b.Mi || ("undefined" !== typeof AudioContext ? b.Mi = new AudioContext : "undefined" !== typeof webkitAudioContext && (b.Mi = new webkitAudioContext),
        b.Mi && Kb(b.Mi));
    ...
    1549346: (a, b, c, d) => {
        function e() {}
        function f(h) {
            void 0 !== g.capture.Ej && (clearTimeout(g.capture.Ej),
            g.capture.Ej = void 0);
    ...
    1550998: (a, b, c, d) => {
        ...
        e.audio.Pi.onaudioprocess = function(f) {
            void 0 !== e && void 0 !== e.audio && (e.audio.Fk = f.outputBuffer,
            Lb("vi", c, [d]))
        }
        ;
    ...
    1552493: a => {
        ...
        if (a) {
            ...
            void 0 !== b.capture.Pi && (b.capture.Pi.onaudioprocess = function() {}
            ,
            b.capture.Pi.disconnect(),
            b.capture.Pi = void 0);
            void 0 !== b.capture.Oj && (b.capture.Oj.disconnect(),
            b.capture.Oj = void 0);
            void 0 !== b.capture.Rj && (b.capture.Rj = void 0);
            b.capture = void 0
        } else
            void 0 != b.audio.Pi && (b.audio.Pi.disconnect(),
            b.audio.Pi = void 0),
            b.audio = void 0;
        void 0 !== b.Mi && void 0 === b.audio && void 0 === b.capture && (b.Mi.close(),
        b.Mi = void 0)
    }
    ,
    1553665: (a, b, c) => {
        k.SDL2 || (k.SDL2 = {});
        var d = k.SDL2;
        d.$k !== k.canvas && (d.Xi = k.createContext(k.canvas, !1, !0),
        d.$k = k.canvas);
        ...
        else if (d.cl !== a && (d.bl = new Int32Array(a.buffer),
...
, Pb = [], Qb, M = a => {
    var b = Pb[a];
    b || (a >= Pb.length && (Pb.length = a + 1),
    Pb[a] = b = Qb.get(a));
    return b
}
, Lb = (a, b, c) => {
    a.includes("j") ? (a = k["dynCall_" + a],
    b = c && c.length ? a.apply(null, [b].concat(c)) : a.call(null, b)) : b = M(b).apply(null, c);
    return b
}
;
function Ib(a, b="i8") {
...
var $b = (a, b) => {
  ...
  , x = (a, b, c) => {
    ...
    for (c = b; a[c] && !(c >= d); )
        ++c;
    if (16 < c - b && a.buffer && ac)
        return ac.decode(a.subarray(b, c));
    for (d = ""; b < c; ) {
        var e = a[b++];
        if (e & 128) {
            var f = a[b++] & 63;
...
var gc = {
    ...
    write(a, b, c, d) {
        if (!a.tty || !a.tty.dj.kk)
            throw new O(60);
        try {
            for (var e = 0; e < d; e++)
                a.tty.dj.kk(a.tty, b[c + e])
        } catch (f) {
            throw new O(29);
        }
  ...
  , hc = {
        ...
        a: {
            if (!bc.length) {
                ...
                if (Ta) {
                    ...
                    null !== a && (a += "\n")) : "function" == typeof readline && (a = readline(),
                    null !== a && (a += "\n"));
                if (!a) {
                    a = null;
                    break a
    ...
    kk(a, b) {
        null === b || 10 === b ? (ab(x(a.output, 0)),
        a.output = []) : 0 != b && a.output.push(b)
    },
    fsync(a) {
        a.output && 0 < a.output.length && (ab(x(a.output, 0)),
        a.output = [])
    },
    rl() {
        return {
  ...
  , ic = {
    kk(a, b) {
        null === b || 10 === b ? (l(x(a.output, 0)),
        a.output = []) : 0 != b && a.output.push(b)
    },
    fsync(a) {
        a.output && 0 < a.output.length && (l(x(a.output, 0)),
        a.output = [])
    }
};
function Ga(a) {
...
var z = {
    ...
    createNode(a, b, c, d) {
        ...
        c = lc(a, b, c, d);
        C(c.mode) ? (c.Gi = z.$i.dir.node,
        c.Ii = z.$i.dir.stream,
        c.Hi = {}) : 32768 === (c.mode & 61440) ? (c.Gi = z.$i.file.node,
        c.Ii = z.$i.file.stream,
        c.Ji = 0,
        c.Hi = null) : 40960 === (c.mode & 61440) ? (c.Gi = z.$i.link.node,
        c.Ii = z.$i.link.stream) : 8192 === (c.mode & 61440) && (c.Gi = z.$i.Ek.node,
        c.Ii = z.$i.Ek.stream);
    ...
    Gi: {
        ...
        readdir(a) {
            var b = [".", ".."], c;
            for (c in a.Hi)
                a.Hi.hasOwnProperty(c) && b.push(c);
            return b
        },
        symlink(a, b, c) {
    ...
    Ii: {
        ...
        write(a, b, c, d, e, f) {
            ...
            if (b.subarray && (!a.Hi || a.Hi.subarray)) {
                if (f)
                    return a.Hi = b.subarray(c, c + d),
                    a.Ji = d;
                if (0 === a.Ji && 0 === e)
                    return a.Hi = b.slice(c, c + d),
                    a.Ji = d;
                if (e + d <= a.Ji)
                    return a.Hi.set(b.subarray(c, c + d), e),
                    d
            }
            jc(a, e + d);
            if (a.Hi.subarray && b.subarray)
                a.Hi.set(b.subarray(c, c + d), e);
            else
                for (f = 0; f < d; f++)
                    a.Hi[e + f] = b[c + f];
  ...
  , oc = (a, b, c) => {
    ...
    , () => {
        if (c)
            ...
            throw `Loading data file "" failed.`;
    }
    );
    d && ub(d)
}
  ...
  , L = {
    ...
    lk: (a, b, c) => {
        ...
        Object.keys(a.entries).forEach(function(q) {
            var u = a.entries[q]
              , v = b.entries[q];
            v && u.timestamp.getTime() == v.timestamp.getTime() || (f.push(q),
            e++)
        });
        var g = [];
...
function nc(a, b) {
    var c;
    if (c = (c = Ic(a, "x")) ? c : a.Gi.lookup ? 0 : 2)
        throw new O(c,a);
...
function Xc(a, b, c) {
    ...
    if (b & 65536 && !C(e.mode))
        throw new O(54);
    if (!d && (c = e ? 40960 === (e.mode & 61440) ? 32 : C(e.mode) && ("r" !== Kc(b) || b & 512) ? 31 : Ic(e, Kc(b)) : 44))
        throw new O(c);
    if (b & 512 && !d) {
        c = e;
...
function Ia(a, b) {
    ...
    if ("string" == typeof b) {
        ...
        ad(a, b, 0, b.byteLength, void 0, c.Ck);
    else
...
function hd(a, b, c, d, e) {
    ...
    f.prototype.Bk = function() {
        ...
        var u = Number(q.getResponseHeader("Content-length")), v, r = (v = q.getResponseHeader("Accept-Ranges")) && "bytes" === v;
        ...
        y.Fi(G => {
            ...
            if ("undefined" == typeof y.ej[G]) {
                var A = y.ej;
                if (K > N)
                    throw Error("invalid range (" + K + ", " + N + ") or no bytes requested!");
                if (N > u - 1)
        ...
        if (q || !u)
            ...
            ab("LazyFiles on gzip forces download of the whole file when length is accessed");
        this.Yk = u;
        this.Xk = B;
        this.ek = !0
    }
...
function md(a, b, c) {
    ...
    E[c + 20 >> 2] = d.rdev;
    J = [d.size >>> 0, (I = d.size,
    1 <= +Math.abs(I) ? 0 < I ? +Math.floor(I / 4294967296) >>> 0 : ~~+Math.ceil((I - +(~~I >>> 0)) / 4294967296) >>> 0 : 0)];
    E[c + 24 >> 2] = J[0];
    E[c + 28 >> 2] = J[1];
    E[c + 32 >> 2] = 4096;
    E[c + 36 >> 2] = d.blocks;
    ...
    J = [Math.floor(a / 1E3) >>> 0, (I = Math.floor(a / 1E3),
    1 <= +Math.abs(I) ? 0 < I ? +Math.floor(I / 4294967296) >>> 0 : ~~+Math.ceil((I - +(~~I >>> 0)) / 4294967296) >>> 0 : 0)];
    E[c + 40 >> 2] = J[0];
    E[c + 44 >> 2] = J[1];
    F[c + 48 >> 2] = a % 1E3 * 1E3;
    J = [Math.floor(b / 1E3) >>> 0, (I = Math.floor(b / 1E3),
    1 <= +Math.abs(I) ? 0 < I ? +Math.floor(I / 4294967296) >>> 0 : ~~+Math.ceil((I - +(~~I >>> 0)) / 4294967296) >>> 0 : 0)];
    E[c + 56 >> 2] = J[0];
    E[c + 60 >> 2] = J[1];
    F[c + 64 >> 2] = b % 1E3 * 1E3;
    J = [Math.floor(e / 1E3) >>> 0, (I = Math.floor(e / 1E3),
    1 <= +Math.abs(I) ? 0 < I ? +Math.floor(I / 4294967296) >>> 0 : ~~+Math.ceil((I - +(~~I >>> 0)) / 4294967296) >>> 0 : 0)];
    E[c + 72 >> 2] = J[0];
    E[c + 76 >> 2] = J[1];
    F[c + 80 >> 2] = e % 1E3 * 1E3;
...
var pd = a => 0 === a % 4 && (0 !== a % 100 || 0 === a % 400), qd = [0, 31, 60, 91, 121, 152, 182, 213, 244, 274, 305, 335], rd = [0, 31, 59, 90, 120, 151, 181, 212, 243, 273, 304, 334], sd = a => {
    var b = aa(a) + 1
      , c = m(b);
    c && t(a, w, c, b);
    return c
        ...
        0 == a)
            ...
            if ("undefined" == typeof setImmediate) {
                ...
                setImmediate = function(d) {
                    c.push(d);
                    Sa ? (void 0 === k.setImmediates && (k.setImmediates = []),
    ...
    Ad = function() {
        if (!eb)
            if (0 < Ed.length) {
                ...
                k.setStatus && (c = k.statusMessage || "Please wait...",
                d = Fd,
                e = Gd.$l,
                d ? d < e ? k.setStatus(c + " (" + (e - d) + "/" + e + ")") : k.setStatus(c) : k.setStatus(""));
                ...
                1 == td && 1 < ud && 0 != Hd % ud)
                    ...
                    if (R)
                        ...
                        c = 0; 21 >= c; ++c)
                            R.kj[c] = 0;
                    eb || k.preMainLoop && !1 === k.preMainLoop() || (Id(a),
                    k.postMainLoop && k.postMainLoop());
                    b < Dd || ("object" == typeof SDL && SDL.audio && SDL.audio.yl && SDL.audio.yl(),
                    xd())
                }
    }
}
...
, wd = !1, xd = null, Dd = 0, vd = null, td = 0, ud = 0, Hd = 0, Ed = [], Gd = {}, yd, Ad, Fd, Od = !1, Pd = !1, Qd = [];
function rc() {
    function a() {
    ...
    if (!Rd) {
            ...
            handle: function(c, d, e) {
                ...
                n.onerror = function() {
                    if (!g) {
                        ...
                        2 == u ? (p += "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/"[(q & 3) << 4],
                        p += "==") : 4 == u && (p += "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/"[(q & 15) << 2],
                        p += "=");
        ...
        k.elementPointerLock && b.addEventListener("click", c => {
            !Pd && k.canvas.requestPointerLock && (k.canvas.requestPointerLock(),
            c.preventDefault())
        }
        , !1))
    }
...
function Td(a, b, c, d) {
    ...
    if (b) {
        ...
        if (d)
            for (var g in d)
                f[g] = d[g];
        if ("undefined" != typeof Ud && (e = Vd(a, f)))
            var h = Wd[e].Ui
    } else
        h = a.getContext("2d");
    if (!h)
        return null;
    c && (b || "undefined" == typeof S || cb("cannot set in module if GLctx is used, but we are a non-GL context that would replace it"),
    k.Xi = h,
    b && Xd(e),
    k.Il = b,
    Qd.forEach(n => n()),
...
function ae(a, b) {
    function c() {
        Od = !1;
        var f = d.parentNode;
        (document.fullscreenElement || document.mozFullScreenElement || document.msFullscreenElement || document.webkitFullscreenElement || document.webkitCurrentFullScreenElement) === f ? (d.exitFullscreen = be,
        Zd && d.requestPointerLock(),
        Od = !0,
        $d ? ("undefined" != typeof SDL && (E[SDL.screen >> 2] = F[SDL.screen >> 2] | 8388608),
        ce(k.canvas),
        de()) : ce(d)) : (f.parentNode.insertBefore(d, f),
        f.parentNode.removeChild(f),
        $d ? ("undefined" != typeof SDL && (E[SDL.screen >> 2] = F[SDL.screen >> 2] & -8388609),
        ce(k.canvas),
        de()) : ce(d));
        if (k.onFullScreen)
            k.onFullScreen(Od);
...
var qc = {}, Rd, T = 12288, ge = !1, he = 0, ie = 0, je = 0, ke = {
    alpha: !1,
    depth: !1,
    stencil: !1,
    antialias: !1
...
, se = 1, te = [], ue = {}, V = [], ve = [], we = [], xe = [], ye = [], ze = [], Wd = [], Ae = [], Be = [], Ce = [], De = [], Ee = [1, 1, 2, 2, 4, 4, 4, 2, 3, 4, 8], Fe = {}, Ge = {}, He = 4;
function W(a) {
    Ie || (Ie = a)
}
var Je = a => {
    for (var b = se++, c = a.length; c < b; c++)
        a[c] = null;
    return b
}
;
...
var kf = {}, gf, df, lf, mf, nf, of, pf, qf, rf, sf, tf, uf, vf, wf, xf = {}, yf = [0, "undefined" != typeof document ? document : 0, "undefined" != typeof window ? window : 0], zf = a => {
    a = 2 < a ? a ? x(w, a) : "" : a;
...
, If = a => 0 > yf.indexOf(a) ? a.getBoundingClientRect() : {
    ...
    if (0 != b.qk || 0 != b.Yj) {
        ...
        var g = Df(a)
          , h = g[0];
        g = g[1];
        3 == b.qk ? (Hf(a, (d - e) / 2, (c - f) / 2),
        c = f,
        d = e) : 2 == b.qk && (c * g < h * d ? (f = g * c / h,
        Hf(a, (d - f) / 2, 0),
        d = f) : (f = h * d / g,
        Hf(a, 0, (c - f) / 2),
        c = f));
        ...
        a.style.width = c + "px";
        a.style.height = d + "px";
        1 == b.jl && (a.style.hj = "optimizeSpeed",
...
, Lf = (a, b) => {
    ...
    for (c = 0; c < b.buttons.length; ++c)
        ib[a + 8 * c + 528 >> 3] = "object" == typeof b.buttons[c] ? b.buttons[c].value : b.buttons[c];
    for (c = 0; c < b.buttons.length; ++c)
        E[a + 4 * c + 1040 >> 2] = "object" == typeof b.buttons[c] ? b.buttons[c].pressed : 1 == b.buttons[c];
...
var Lg = (a, b, c, d, e, f, g, h) => {
  ...
  , Pg = (a, b, c) => {
    if (b) {
        ...
        if (void 0 === d)
            ...
            default:
                W(1280);
                l("GL_INVALID_ENUM in glGet" + c + "v: Native code calling glGet" + c + "v(" + a + ") and it returns " + e + " of type " + typeof e + "!");
                return
            }
        switch (c) {
        case 1:
  ...
  , Vg = (a, b, c) => {
    if (c)
        ...
        35716 == b)
            ...
            E[c >> 2] = S.getProgramParameter(a, b);
    else
        W(1281)
}
  , Wg = (a, b, c) => {
    if (c) {
        a = Ae[a];
        b = 2 > R.version ? S.Wi.getQueryObjectEXT(a, b) : S.getQueryParameter(a, b);
        var d;
  ...
  , Zg = (a, b, c) => {
    c ? 35716 == b ? (a = S.getShaderInfoLog(ye[a]),
    null === a && (a = "(unknown error)"),
    E[c >> 2] = a ? a.length + 1 : 0) : 35720 == b ? (a = S.getShaderSource(ye[a]),
    E[c >> 2] = a ? a.length + 1 : 0) : E[c >> 2] = S.getShaderParameter(ye[a], b) : W(1281)
}
  , $g = a => {
    var b = Fe[a];
    if (!b) {
  ...
  , bh = a => {
    ...
    if (!b)
        for (a.Gj = b = {},
        a.Sk = {},
        d = 0; d < S.getProgramParameter(a, 35718); ++d) {
  ...
  , ch = (a, b) => {
    ...
    if (a = V[a]) {
        ...
        e = b.slice(0, f));
        if ((e = a.Tk[e]) && d < e[0] && (d += e[1],
        c[d] = c[d] || S.getUniformLocation(a, b)))
            return d
    } else
        W(1281);
    return -1
  ...
  , eh = (a, b, c, d) => {
    if (c)
        if (R.fj[a].enabled && l("glGetVertexAttrib*v on client-side array: not supported, bad data returned"),
  ...
  , lh = (a, b, c, d, e, f, g) => {
    if (2 <= R.version)
        if (S.$j)
            S.readPixels(a, b, c, d, e, f, g);
        else {
            var h = jh(f);
            S.readPixels(a, b, c, d, e, f, h, g >> 31 - Math.clz32(h.BYTES_PER_ELEMENT))
        }
    else
        (g = kh(f, e, c, d, g)) ? S.readPixels(a, b, c, d, e, f, g) : W(1280)
}
;
function mh(a, b, c, d) {
...
var sh = (a, b, c, d, e, f, g, h, n) => {
    if (2 <= R.version)
        if (S.Yi)
            S.texImage2D(a, b, c, d, e, f, g, h, n);
        else if (n) {
            var p = jh(h);
            S.texImage2D(a, b, c, d, e, f, g, h, p, n >> 31 - Math.clz32(p.BYTES_PER_ELEMENT))
        } else
            S.texImage2D(a, b, c, d, e, f, g, h, null);
    else
        S.texImage2D(a, b, c, d, e, f, g, h, n ? kh(h, g, d, e, n) : null)
}
;
function th(a, b, c) {
...
var uh = (a, b, c, d, e, f, g, h, n) => {
    if (2 <= R.version)
        if (S.Yi)
            S.texSubImage2D(a, b, c, d, e, f, g, h, n);
        else if (n) {
            var p = jh(h);
            S.texSubImage2D(a, b, c, d, e, f, g, h, p, n >> 31 - Math.clz32(p.BYTES_PER_ELEMENT))
        } else
            S.texSubImage2D(a, b, c, d, e, f, g, h, null);
    else
        p = null,
        n && (p = kh(h, g, e, f, n)),
  ...
  , xh = (a, b, c) => {
    if (2 <= R.version)
        b && S.uniform1fv(X(a), H, c >> 2, b);
    else {
        if (288 >= b)
            for (var d = wh[b - 1], e = 0; e < b; ++e)
                d[e] = H[c + 4 * e >> 2];
        else
            d = H.subarray(c >> 2, c + 4 * b >> 2);
        S.uniform1fv(X(a), d)
    }
}
  , yh = (a, b) => {
  ...
  , Ah = (a, b, c) => {
    if (2 <= R.version)
        b && S.uniform1iv(X(a), E, c >> 2, b);
    else {
        if (288 >= b)
            for (var d = zh[b - 1], e = 0; e < b; ++e)
                d[e] = E[c + 4 * e >> 2];
        else
  ...
  , Bh = (a, b, c) => {
    if (2 <= R.version)
        ...
        if (144 >= b)
            ...
            d = H.subarray(c >> 2, c + 8 * b >> 2);
        S.uniform2fv(X(a), d)
    }
}
  , Ch = (a, b, c) => {
    if (2 <= R.version)
        b && S.uniform2iv(X(a), E, c >> 2, 2 * b);
    else {
        if (144 >= b)
  ...
  , Dh = (a, b, c) => {
    if (2 <= R.version)
        ...
        if (96 >= b)
            ...
            d = H.subarray(c >> 2, c + 12 * b >> 2);
        S.uniform3fv(X(a), d)
    }
}
  , Eh = (a, b, c) => {
    if (2 <= R.version)
        b && S.uniform3iv(X(a), E, c >> 2, 3 * b);
    else {
        if (96 >= b)
  ...
  , Fh = (a, b, c) => {
    if (2 <= R.version)
        ...
        if (72 >= b) {
            ...
            d = H.subarray(c >> 2, c + 16 * b >> 2);
        S.uniform4fv(X(a), d)
    }
}
  , Gh = (a, b, c) => {
    if (2 <= R.version)
        b && S.uniform4iv(X(a), E, c >> 2, 4 * b);
    else {
        if (72 >= b)
  ...
  , Hh = (a, b, c, d) => {
    if (2 <= R.version)
        b && S.uniformMatrix2fv(X(a), !!c, H, d >> 2, 4 * b);
    else {
        if (72 >= b)
            ...
            e = H.subarray(d >> 2, d + 16 * b >> 2);
        S.uniformMatrix2fv(X(a), !!c, e)
    }
}
  , Ih = (a, b, c, d) => {
    if (2 <= R.version)
        b && S.uniformMatrix3fv(X(a), !!c, H, d >> 2, 9 * b);
    else {
        if (32 >= b)
            ...
            e = H.subarray(d >> 2, d + 36 * b >> 2);
        S.uniformMatrix3fv(X(a), !!c, e)
    }
}
  , Jh = (a, b, c, d) => {
    if (2 <= R.version)
        b && S.uniformMatrix4fv(X(a), !!c, H, d >> 2, 16 * b);
    else {
        if (18 >= b) {
            var e = wh[16 * b - 1]
              , f = H;
  ...
  , Mh = (a, b, c, d, e, f) => {
    var g = R.fj[a];
    S.uj ? (g.Bj = !1,
    S.vertexAttribPointer(a, b, c, !!d, e, f)) : (g.size = b,
    g.type = c,
    g.ik = d,
    g.Sj = e,
    g.Dj = f,
...
var Oh = (a, b) => {
    if (!jf())
        return -1;
    a = zf(a);
    return a ? a.requestFullscreen || a.webkitRequestFullscreen ? cf() ? Jf(a, b) : b.el ? (af(Jf, 1, [a, b]),
    1) : -2 : -3 : -4
}
  , Ph = (a, b) => {
    var c = {
...
function ei(a, b, c, d, e) {
    function f() {
        ...
        0 < fa && (U = m(fa),
        w.set(new Uint8Array(A.response), U));
        F[a + 12 >> 2] = U;
        Og(a + 16, fa);
        Og(a + 24, 0);
    ...
    if (g) {
        ...
        A.onprogress = U => {
            if (ci.has(P)) {
                var fa = K && N && A.response ? A.response.byteLength : 0
                  , Q = 0;
                0 < fa && K && N && (Q = m(fa),
                w.set(new Uint8Array(A.response), Q));
                F[a + 12 >> 2] = Q;
                Og(a + 16, fa);
                Og(a + 24, U.loaded - fa);
                Og(a + 32, U.total);
        ...
        A.onreadystatechange = U => {
            ci.has(P) && (hb[a + 40 >> 1] = A.readyState,
...
var ii = ["default", "low-power", "high-performance"], ji = [null], Y = null, ki = {}, mi = () => {
    if (!li) {
        var a = {
            USER: "web_user",
            LOGNAME: "web_user",
        ...
        for (b in ki)
            void 0 === ki[b] ? delete a[b] : a[b] = ki[b];
        var c = [];
        for (b in a)
            c.push(`=${a[b]}`);
        li = c
...
for (var S, xi = 0; 32 > xi; ++xi)
    tg.push(Array(xi));
var yi = new Float32Array(288);
for (xi = 0; 288 > xi; ++xi)
    wh[xi] = yi.subarray(0, xi + 1);
var zi = new Int32Array(288);
for (xi = 0; 288 > xi; ++xi)
    zh[xi] = zi.subarray(0, xi + 1);
ci = new bi;
...
var Ei = {
    Tb: function(a) {
        try {
            ...
            if ("undefined" == typeof jd || "ErrnoError" !== d.name)
                throw d;
            return -d.Ki
        }
    },
    Fa: function(a, b, c) {
        ...
        try {
            ...
            if ("undefined" == typeof jd || "ErrnoError" !== f.name)
                throw f;
            return -f.Ki
        }
    },
    Kb: function(a, b, c) {
        try {
            ...
            if ("undefined" == typeof jd || "ErrnoError" !== q.name)
                throw q;
            return -q.Ki
        }
    },
    Ub: function(a, b, c) {
        ...
        try {
            ...
            if ("undefined" == typeof jd || "ErrnoError" !== g.name)
                throw g;
            return -g.Ki
        }
    },
    Ob: function(a, b) {
        try {
            ...
            if ("undefined" == typeof jd || "ErrnoError" !== c.name)
                throw c;
            return -c.Ki
        }
    },
    ...
    Jb: function(a, b, c, d) {
        try {
            ...
            if ("undefined" == typeof jd || "ErrnoError" !== h.name)
                throw h;
            return -h.Ki
        }
    },
    ...
    Hb: function(a) {
        try {
            ...
            if ("undefined" == typeof jd || "ErrnoError" !== b.name)
                throw b;
            return -b.Ki
        }
    },
    ...
    Ib: function(a, b, c) {
        try {
            return b = b ? x(w, b) : "",
            b = ld(a, b),
            0 === c ? Ma(b) : 512 === c ? La(b) : cb("Invalid flags passed to unlinkat"),
            0
        } catch (d) {
            if ("undefined" == typeof jd || "ErrnoError" !== d.name)
                throw d;
    ...
    Ab: function(a) {
        var b = new Date(E[a + 20 >> 2] + 1900,E[a + 16 >> 2],E[a + 12 >> 2],E[a + 8 >> 2],E[a + 4 >> 2],E[a >> 2],0)
          ...
          , g = Math.min(f, e);
        0 > c ? E[a + 32 >> 2] = Number(e != f && g == d) : 0 < c != (g == d) && (e = Math.max(f, e),
        b.setTime(b.getTime() + 6E4 * ((0 < c ? g : e) - d)));
        E[a + 24 >> 2] = b.getDay();
        E[a + 28 >> 2] = (pd(b.getFullYear()) ? qd : rd)[b.getMonth()] + b.getDate() - 1 | 0;
        E[a >> 2] = b.getSeconds();
    ...
    Bb: function(a) {
        ...
        E[a + 28 >> 2] = (b.getTime() - Date.UTC(b.getUTCFullYear(), 0, 1, 0, 0, 0, 0)) / 864E5 | 0;
        a = b.getTime() / 1E3;
        return Bi((I = a,
        1 <= +Math.abs(I) ? 0 < I ? +Math.floor(I / 4294967296) >>> 0 : ~~+Math.ceil((I - +(~~I >>> 0)) / 4294967296) >>> 0 : 0)),
        a >>> 0
    ...
    Ah: (a, b, c, d) => {
        ...
        switch (c) {
        case 12320:
            return E[d >> 2] = ke.alpha ? 32 : 24,
            1;
        case 12321:
            return E[d >> 2] = ke.alpha ? 8 : 0,
            1;
        case 12322:
            return E[d >> 2] = 8,
            1;
        ...
        case 12324:
            ...
            1;
        case 12325:
            return E[d >> 2] = ke.depth ? 24 : 0,
            1;
        case 12326:
            return E[d >> 2] = ke.stencil ? 8 : 0,
            1;
        case 12327:
            return E[d >> 2] = 12344,
            1;
        ...
        case 12335:
            ...
            1;
        case 12337:
            return E[d >> 2] = ke.antialias ? 4 : 0,
            1;
        case 12338:
            return E[d >> 2] = ke.antialias ? 1 : 0,
            1;
        case 12339:
            return E[d >> 2] = 4,
            1;
    ...
    Mh: (a, b, c, d, e, f, g, h) => {
        ...
        q.onprogress = function(v) {
            h && M(h)(u, d, v.loaded, v.lengthComputable || void 0 === v.lengthComputable ? v.total : 0)
        }
        ;
        q.onabort = function() {
            delete Qe[u]
    ...
    Sd: (a, b, c, d, e, f, g, h, n) => {
        S.Yi ? S.compressedTexImage3D(a, b, c, d, e, f, g, h, n) : S.compressedTexImage3D(a, b, c, d, e, f, g, w, n, h)
    }
    ,
    ...
    Hc: (a, b) => (a = S.fenceSync(a, b)) ? (b = Je(De),
    a.name = b,
    De[b] = a,
    b) : 0,
    Tf: function() {
    ...
    wd: (a, b, c) => {
        if (Bg(a)) {
            var d = ue[Ag(a)];
            d ? d.zk & 16 ? 0 > b || 0 > c || b + c > d.length ? (W(1281),
            l("invalid range in glFlushMappedBufferRange")) : S.bufferSubData(a, d.offset, w.subarray(d.cj + b, d.cj + b + c)) : (W(1282),
            l("buffer was not mapped with GL_MAP_FLUSH_EXPLICIT_BIT in glFlushMappedBufferRange")) : (W(1282),
            l("buffer was never mapped in glFlushMappedBufferRange"))
        } else
            W(1280),
            l("GL_INVALID_ENUM in glFlushMappedBufferRange")
    }
    ,
    Rf: Cg,
    Qf: Dg,
    ...
    Mc: (a, b, c, d) => {
        if (d)
            ...
            35393 == c)
                ...
                if (a = S.getActiveUniformBlockParameter(a, b, c),
                null !== a)
                    if (35395 == c)
    ...
    Id: (a, b, c) => {
        if (35005 == b) {
            ...
            W(1280),
            l("GL_INVALID_ENUM in glGetBufferPointerv")
    }
    ,
    Df: Qg,
    Cf: Rg,
    ...
    $b: (a, b, c, d, e) => {
        if (0 > d)
            ...
            if (a = S.getInternalformatParameter(a, b, c),
            null !== a)
    ...
    ,
    Bc: (a, b, c, d, e) => {
        0 > c ? W(1281) : e ? (a = S.getSyncParameter(De[a], b),
        null !== a && (E[e >> 2] = a,
        d && (E[d >> 2] = 1))) : W(1281)
    }
    ,
    ...
    id: fh,
    kf: (a, b, c) => {
        c ? (R.fj[a].enabled && l("glGetVertexAttribPointer on client-side array: not supported, bad data returned"),
        E[c >> 2] = S.getVertexAttribOffset(a, b)) : W(1281)
    }
    ,
    mf: (a, b, c) => {
        eh(a, b, c, 2)
    ...
    dc: (a, b, c) => {
        for (var d = tg[b], e = 0; e < b; e++)
            d[e] = E[c + 4 * e >> 2];
        S.invalidateFramebuffer(a, d)
    }
    ,
    cc: (a, b, c, d, e, f, g) => {
        for (var h = tg[b], n = 0; n < b; n++)
            h[n] = E[c + 4 * n >> 2];
    ...
    xd: (a, b, c, d) => {
        if (0 != (d & 33))
            return l("glMapBufferRange access does not support MAP_READ or MAP_UNSYNCHRONIZED"),
            0;
        if (0 == (d & 2))
            return l("glMapBufferRange access must include MAP_WRITE"),
            0;
        if (0 == (d & 12))
            return l("glMapBufferRange access must include INVALIDATE_BUFFER or INVALIDATE_RANGE"),
            0;
        if (!Bg(a))
            return W(1280),
            l("GL_INVALID_ENUM in glMapBufferRange"),
            0;
        var e = m(c);
        a = Ag(a);
        if (!e)
    ...
    Ud: (a, b, c, d, e, f, g, h, n, p, q) => {
        if (S.Yi)
            S.texSubImage3D(a, b, c, d, e, f, g, h, n, p, q);
        else if (q) {
            var u = jh(p);
            S.texSubImage3D(a, b, c, d, e, f, g, h, n, p, u, q >> 31 - Math.clz32(u.BYTES_PER_ELEMENT))
        } else
            S.texSubImage3D(a, b, c, d, e, f, g, h, n, p, null)
    }
    ,
    md: (a, b, c, d) => {
        a = V[a];
    ...
    Jd: a => {
        if (!Bg(a))
            return W(1280),
            l("GL_INVALID_ENUM in glUnmapBuffer"),
            0;
        var b = ue[Ag(a)];
        if (!b || !b.cj)
            return W(1282),
            l("buffer was never mapped in glUnmapBuffer"),
            0;
    ...
    kd: (a, b, c, d, e) => {
        var f = R.fj[a];
        S.uj ? (f.Bj = !1,
        S.vertexAttribIPointer(a, b, c, d, e)) : (f.size = b,
        f.type = c,
        f.ik = !1,
        f.Sj = d,
        f.Dj = e,
    ...
    ja: (a, b) => {
        a = zf(a);
        return a ? a.requestPointerLock ? cf() ? Kf(a) : b ? (af(Kf, 2, [a]),
        1) : -2 : -1 : -4
    }
    ,
    Eb: a => {
    ...
    Oa: (a, b, c) => "undefined" == typeof onbeforeunload ? -1 : 1 !== c ? -5 : Ph(a, b),
    ...
    Ua: (a, b, c) => navigator.getGamepads || navigator.webkitGetGamepads ? Sh(a, b, c, 27, "gamepaddisconnected") : -1,
    ...
    N: (a, b, c, d) => {
        if (!document || !document.body || !(document.body.requestPointerLock || document.body.Xj || document.body.Ol || document.body.Ml))
            return -1;
        a = zf(a);
        if (!a)
            return -4;
    ...
    Ea: function(a, b, c, d) {
        try {
            ...
            if ("undefined" == typeof jd || "ErrnoError" !== N.name)
                throw N;
            return N.Ki
        }
    },
    ...
    Da: function(a, b, c, d) {
        try {
            ...
            if ("undefined" == typeof jd || "ErrnoError" !== u.name)
                throw u;
            return u.Ki
        }
    },
    wh: (a, b, c, d) => {
            ...
            if (10 === u)
                a: {
                    ...
                    for (A = 0; 8 > A; A++)
                        ...
                        fa = A - P + 1);
                    for (A = 0; 8 > A; A++)
                        1 < P && 0 === y[A] && A >= fa && A < fa + P ? A === fa && (N += ":",
                        0 === fa && (N += ":")) : (N += Number(Ci(y[A] & 65535)).toString(16),
                        N += 7 > A ? ":" : "")
                }
            else
                N = ti(y);
        ...
        if (!a)
            return 0 === n && (n = 2),
            0 === (h & 1) && (2 === n ? f = Di(2130706433) : f = [0, 0, 0, 1]),
            a = e(n, p, q, null, f, g),
            F[d >> 2] = a,
            0;
        a = a ? x(w, a) : "";
  ...
  , Z = function() {
    ...
    if (k.instantiateWasm)
        try {
            ...
            return l(`Module.instantiateWasm callback failed with error: `),
            !1
        }
    Db(b, function(c) {
        a(c.instance)
...
function Ji() {
    ...
    function b() {
        ...
        !eb)) {
            ...
            k.stdout ? fd("/dev", "stdout", null, k.stdout) : Vc("/dev/tty", "/dev/stdout"),
            k.stderr ? fd("/dev", "stderr", null, k.stderr) : Vc("/dev/tty1", "/dev/stderr"),
            Xc("/dev/stdin", 0),
            Xc("/dev/stdout", 1),
            Xc("/dev/stderr", 1));
            Bc = !1;
    ...
    if (!(0 < rb)) {
        if (k.preRun)
            for ("function" == typeof k.preRun && (k.preRun = [k.preRun]); k.preRun.length; )
                qb();
        Ob(kb);
        0 < rb || (k.setStatus ? (k.setStatus("Running..."),
        setTimeout(function() {
            setTimeout(function() {
                k.setStatus("")
            }, 1);
...
(function() {
    if ("undefined" != typeof window && !window.Fi) {
        ...
        class c {
            ...
            destroy() {
                null != this.transport && this.transport && (this.transport.close(),
                this.transport = null);
                this.nj = null
            }
            async connect(d, e) {
            ...
            async send(d, e) {
                ...
                if (this.nj) {
                    ...
                    f = new ArrayBuffer(e);
                    for (var g = new Uint8Array(f), h = 0; h < e; h++)
                        g[h] = d[h];
                    this.nj.write(f)
                } else
...
"undefined" != typeof window && (api_error_callback = k.cwrap("api_error_callback", null, ["number", "string"]),
create_game_callback = k.cwrap("create_game_callback", null, ["string", "string", "string"]),
join_game_callback = k.cwrap("join_game_callback", null, ["string"]),
chat_callback = k.cwrap("chat_callback", null, ["string", "number"]),
player_info_callback = k.cwrap("player_info_callback", null, "number string string string bool string".split(" ")),
...
gxc_request_room = (a, b, c, d, e, f) => {
    ...
    fetch("https://" + a + "/gg/games/" + e + "/rooms" + (f.length ? "?trackId=" + f : ""), b).then(n => {
        n.ok ? n.json().then(p => {
            ...
            g ? (q = location.protocol + "//" + location.host + location.pathname + "?game=debug&roomUrl=" + u,
            set_local_share_url(q)) : post_share_url(q);
    ...
    fetch("https://" + a + "/gg/v2/rooms?roomUrl=" + c, d).then(f => {
        f.ok ? f.json().then(g => {
            ...
            gxc_player_info.forEach(h => {
                null !== h.playerId && (null === h.user.userId ? (h.user.userId = "",
                h.user.guest = !0) : h.user.guest = !1,
...
"undefined" != typeof window && (wallpaper_update_config = k.cwrap("wallpaper_update_config", null, ["string"]),
wallpaper_reset_config = k.cwrap("wallpaper_reset_config", null, ["string"]),
wallpaper_update_subscription_data = k.cwrap("wallpaper_update_subscription_data", null, ["string"]));
